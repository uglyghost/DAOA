...
public:
  ...
  void
  SetWindowSize(uint32_t windowSize)
  {
      m_windowSize = windowSize;
  }

protected:
  TracedCallback<Ptr<ns3::ndn::App> /* app */, double /* m_windowSize */> m_FileWindowSize;

  virtual bool
  SendPacket();

  virtual void
  AfterData(bool manifest, bool timeout, uint32_t seq_nr, double price);

  bool m_congestionControl;
  double m_windowSize;
  double m_timestamp;
