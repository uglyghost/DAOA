...
#ifndef NFD_DAEMON_FW_KNOWLEDGE_STRATEGY_HPP
#define NFD_DAEMON_FW_KNOWLEDGE_STRATEGY_HPP
 ...
 */
class KnowledgeRouteStrategy : public Strategy
{
public:
  KnowledgeRouteStrategy(Forwarder& forwarder, const Name& name = STRATEGY_NAME);

  virtual
  ~KnowledgeRouteStrategy();
...
#endif // NFD_DAEMON_FW_KNOWLEDGE_STRATEGY_HPP
