...
Face::Face(const FaceUri& remoteUri, const FaceUri& localUri, bool isLocal, bool isMultiAccess, double FaceBij, double PreFaceBij, int Queue, int PreQueue, int PPreQueue)
  : m_id(INVALID_FACEID)
  ...
  , serverIndex(false)
  , m_facebij(FaceBij)
  , m_prefacebij(PreFaceBij)
  , m_queue(Queue)
  , m_prequeue(PreQueue)
  , m_pprequeue(PPreQueue)
{
